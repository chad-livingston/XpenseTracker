...
public class xpense {
	...
	public static void main(String[] args) {
		...
		//shows the user the available commands
			if (in.nextLine().toLowerCase().equals("cmd") || in.nextLine().toLowerCase().equals("add") || in.nextLine().toLowerCase().equals("removelast") || in.nextLine().toLowerCase().equals("view") || in.nextLine().toLowerCase().equals("reset") || in.nextLine().toLowerCase().equals("sum") || in.nextLine().toLowerCase().equals("exit")){
				if (in.nextLine() == "cmd") {
